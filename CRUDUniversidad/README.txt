...
a persistence unit "CRUDUniversidadPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "CRUDUniversidad\pom.xml":
...
artifact ("CRUDUniversidad.war") is already built. You can build
